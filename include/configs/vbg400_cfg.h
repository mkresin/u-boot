...
#define IFX_CFG_FLASH_DATA_BLOCKS_INFO                                  \
  ...
  #define IFX_CFG_FLASH_UBOOT_CFG_SIZE                   0x8000
  #define IFX_CFG_FLASH_UBOOT_CFG_END_ADDR               0x003F8000

  #define IFX_CFG_FLASH_CALIBRATION_CFG_BLOCK_NAME	     "calibration"
  #define IFX_CFG_FLASH_CALIBRATION_CFG_START_ADDR	     0x003F8000
  #define IFX_CFG_FLASH_CALIBRATION_CFG_SIZE             0x1000
  #define IFX_CFG_FLASH_CALIBRATION_CFG_END_ADDR         0x003F8FFF

  #define IFX_CFG_FLASH_END_ADDR                         0x003FFFFF

#define IFX_CFG_FLASH_CALIBRATION_START_ADDR IFX_CFG_FLASH_CALIBRATION_CFG_START_ADDR
...
#define IFX_CFG_FLASH_DATA_BLOCKS_INFO                                  \
  ...
  #define IFX_CFG_FLASH_KERNEL_IMAGE_BLOCK_NAME          "kernel"
  #define IFX_CFG_FLASH_KERNEL_IMAGE_START_ADDR          0x00440000
  #define IFX_CFG_FLASH_KERNEL_IMAGE_SIZE                0
  ...
  #define IFX_CFG_FLASH_CALIBRATION_CFG_BLOCK_NAME       "calibration"
  #define IFX_CFG_FLASH_CALIBRATION_CFG_START_ADDR       0x007F0000
  #define IFX_CFG_FLASH_CALIBRATION_CFG_SIZE             0x1000
  #define IFX_CFG_FLASH_CALIBRATION_CFG_END_ADDR         0x007F0FFF
