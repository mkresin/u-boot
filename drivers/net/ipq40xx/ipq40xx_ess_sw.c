...
/*
		...
		S17_PORT_FULL_DUP, bit 6, 1 full
								, 0 half
		*/
		ipq40xx_ess_sw_wr(S17_P5STATUS_REG, 0x1280 | S17_PORT_TX_MAC_EN | S17_PORT_RX_MAC_EN);
		ipq40xx_ess_sw_wr(S17_P5LOOKUP_CTRL_REG, 0x140000); // disable lookup, maybe no need since we only has one phy connect to mac5 ?
