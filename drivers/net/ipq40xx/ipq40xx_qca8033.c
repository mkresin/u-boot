...
{
	u32 _8035_phy_id_ = 0x1; /* patch for AR8035: PHY address=1 */
	u16 phy_data;
	...
	phy_data = qca8033_phy_reg_read(0x0, _8035_phy_id_, QCA8033_PHY_ID1);
	printf ("PHY ID1: 0x%x\n", phy_data);
	phy_data = qca8033_phy_reg_read(0x0, _8035_phy_id_, QCA8033_PHY_ID2);
	printf ("PHY ID2: 0x%x\n", phy_data);

	qca8033_phy_reg_write(0x0, _8035_phy_id_, 0x1d, 0x5);
	qca8033_phy_reg_write(0x0, _8035_phy_id_, 0x1e, 0x2d47);
	qca8033_phy_reg_write(0x0, _8035_phy_id_, 0x1d, 0xb);
	qca8033_phy_reg_write(0x0, _8035_phy_id_, 0x1e, 0xbc40);
	qca8033_phy_reg_write(0x0, _8035_phy_id_, 0x1d, 0x0);
	qca8033_phy_reg_write(0x0, _8035_phy_id_, 0x1e, 0x82ee);
