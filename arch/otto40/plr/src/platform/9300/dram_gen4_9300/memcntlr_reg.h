...
typedef union {
	struct {
		...
		unsigned int no_use12:11; //0
		unsigned int rq_en:1;	//0
	} f;
	unsigned int v;
} DCR_T;
...
typedef union {
	struct {
		unsigned int mbz_0:2;	
		unsigned int dqs1_clk_en:1;
		unsigned int dqs1_clk_ph_sel:1;
		unsigned int mbz_1:2;
		unsigned int dqs0_clk_en:1;
		unsigned int dqs0_clk_ph_sel:1;
		unsigned int mbz_2:2;
		unsigned int dq15_8_clk_en:1;
		unsigned int dq15_8_clk_ph_sel:1;
		unsigned int mbz_3:2;
		unsigned int dq7_0_clk_en:1;
		unsigned int dq7_0_clk_ph_sel:1;
		unsigned int mbz_4:2;
		unsigned int dqs1_wr_phy_ph_adj:2;	
		unsigned int mbz_5:2;				
		unsigned int dqs0_wr_phy_ph_adj:2;		
		unsigned int mbz_6:8;			
	} f;
	unsigned int v;
} DCPER_T;
...
typedef union {
	struct {
		...
		unsigned int done:1;
		unsigned int err:1;
		unsigned int zctrl_status:8;
		unsigned int zctrl_imp:21; //0
	} f;
	unsigned int v;
} DDZQPSR_T;
...
typedef union {
	struct {
		unsigned int mbz_0:3;				//0
		unsigned int dqs1_out_en_delay:5;	//0
		unsigned int mbz_1:3;				//0
		unsigned int dqs0_out_en_delay:5;	//0
		unsigned int mbz_2:16;				//0
	} f;
	unsigned int v;
} DWDQSOR_T;
...
typedef union {
	struct {
		...
		unsigned int dq3_out_en_delay:5;
		unsigned int mbz_1:3;
		unsigned int dq2_out_en_delay:5;
		unsigned int mbz_2:3;
		unsigned int dq1_out_en_delay:5;
		unsigned int mbz_3:3;
		unsigned int dq0_out_en_delay:5;
	} f;
	unsigned int v;
} DWDQOR0_T;
#define DWDQOR0ar (0xb80015d0)
#define DWDQOR0rv (*((regval)DWDQOR0ar))
#define DWDQOR0dv (0x00000000)
#define RMOD_DWDQOR0(...) rset(DWDQOR0, DWDQOR0rv, __VA_ARGS__)
#define RIZS_DWDQOR0(...) rset(DWDQOR0, 0, __VA_ARGS__)
#define RFLD_DWDQOR0(fld) (*((const volatile DWDQOR0_T *)DWDQOR0ar)).f.fld


typedef union {
	struct {
		unsigned int mbz_0:3;
		unsigned int dq7_out_en_delay:5;
		unsigned int mbz_1:3;
		unsigned int dq6_out_en_delay:5;
		unsigned int mbz_2:3;
		unsigned int dq5_out_en_delay:5;
		unsigned int mbz_3:3;
		unsigned int dq4_out_en_delay:5;
	} f;
	unsigned int v;
} DWDQOR1_T;
#define DWDQOR1ar (0xb80015d4)
#define DWDQOR1rv (*((regval)DWDQOR1ar))
#define DWDQOR1dv (0x00000000)
#define RMOD_DWDQOR1(...) rset(DWDQOR1, DWDQOR1rv, __VA_ARGS__)
#define RIZS_DWDQOR1(...) rset(DWDQOR1, 0, __VA_ARGS__)
#define RFLD_DWDQOR1(fld) (*((const volatile DWDQOR1_T *)DWDQOR1ar)).f.fld

typedef union {
	struct {
		unsigned int mbz_0:3;
		unsigned int dq11_out_en_delay:5;
		unsigned int mbz_1:3;
		unsigned int dq10_out_en_delay:5;
		unsigned int mbz_2:3;
		unsigned int dq9_out_en_delay:5;
		unsigned int mbz_3:3;
		unsigned int dq8_out_en_delay:5;
	} f;
	unsigned int v;
} DWDQOR2_T;
#define DWDQOR2ar (0xb80015d8)
#define DWDQOR2rv (*((regval)DWDQOR2ar))
#define DWDQOR2dv (0x00000000)
#define RMOD_DWDQOR2(...) rset(DWDQOR2, DWDQOR2rv, __VA_ARGS__)
#define RIZS_DWDQOR2(...) rset(DWDQOR2, 0, __VA_ARGS__)
#define RFLD_DWDQOR2(fld) (*((const volatile DWDQOR2_T *)DWDQOR2ar)).f.fld

typedef union {
	struct {
		unsigned int mbz_0:3;
		unsigned int dq15_out_en_delay:5;
		unsigned int mbz_1:3;
		unsigned int dq14_out_en_delay:5;
		unsigned int mbz_2:3;
		unsigned int dq13_out_en_delay:5;
		unsigned int mbz_3:3;
		unsigned int dq12_out_en_delay:5;
	} f;
	unsigned int v;
} DWDQOR3_T;
#define DWDQOR3ar (0xb80015dc)
#define DWDQOR3rv (*((regval)DWDQOR3ar))
#define DWDQOR3dv (0x00000000)
#define RMOD_DWDQOR3(...) rset(DWDQOR3, DWDQOR3rv, __VA_ARGS__)
#define RIZS_DWDQOR3(...) rset(DWDQOR3, 0, __VA_ARGS__)
#define RFLD_DWDQOR3(fld) (*((const volatile DWDQOR3_T *)DWDQOR3ar)).f.fld
