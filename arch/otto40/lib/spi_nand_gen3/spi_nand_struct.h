...
/* Version Info. */
#define SYM_SPI_NAND_VER    0x534E0C03
...
typedef void (spi_nand_send_instr_gen_t) (u32_t cs, u32_t opcode, u32_t settings, u32_t io_len);
...
typedef void (spi_nand_die_sel_t) (u32_t cs, u32_t die_index);
typedef u32_t (spi_nand_stack2die_addr_trans_t) (spi_nand_flash_info_t *info, u32_t blk_pge_addr, spi_nand_die_sel_t *sel_die_func);
...
#define SNAF_MODEL_PAGE_SIZE_8192B      (3) //1024*(1<<3)
...
#define PLANE_SHF_BITS(model_pge_size)  (model_pge_size+11)
