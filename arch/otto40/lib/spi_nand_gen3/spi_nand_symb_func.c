...
spi_nand_cmd_info_t    *_nsu_x2_cmd_info_ptr SECTION_SDATA;
...
ecc_encode_t  *_nsu_ecc_encode_4Kpage_ptr SECTION_RECYCLE_DATA = (ecc_encode_t *)_spi_nand_dummy_func;
ecc_decode_t  *_nsu_ecc_decode_4Kpage_ptr SECTION_RECYCLE_DATA = (ecc_decode_t *)_spi_nand_dummy_func;
ecc_engine_t  *_nsu_ecc_engine_action_ptr SECTION_RECYCLE_DATA = (ecc_engine_t *)_spi_nand_dummy_func;
spi_nand_page_read_write_ecc_t  *_nsu_page_read_with_ode_ptr SECTION_RECYCLE_DATA = (spi_nand_page_read_write_ecc_t *)_spi_nand_dummy_func;
spi_nand_page_read_write_ecc_t  *_nsu_page_write_with_ode_ptr SECTION_RECYCLE_DATA = (spi_nand_page_read_write_ecc_t *)_spi_nand_dummy_func;
...
spi_nand_send_instr_gen_t       *_nsu_send_instr_gen_ptr SECTION_SDATA = (spi_nand_send_instr_gen_t *)_spi_nand_dummy_func;   
spi_nand_stack2die_addr_trans_t *_nsu_s2d_addr_trans_ptr SECTION_SDATA = (spi_nand_stack2die_addr_trans_t *)_spi_nand_dummy_func;
...
symb_retrive_entry_t spi_nand_func_retrive_list[] SECTION_RECYCLE_DATA = {
    ...
    {ECC_BCH_ENCODE_4KPAGE_FUNC, &_nsu_ecc_encode_4Kpage_ptr},
    {ECC_BCH_DECODE_4KPAGE_FUNC, &_nsu_ecc_decode_4Kpage_ptr},    
    ...
    {SNAF_STACK2DIE_ADDR_TRANS_FUNC, &_nsu_s2d_addr_trans_ptr},
    ...
    {SPI_NAND_X2_CMD_INFO, &_nsu_x2_cmd_info_ptr},
    {SPI_NAND_DIO_CMD_INFO, &_nsu_dio_cmd_info_ptr},
...
spi_nand_func_symbol_retrive(void)
{
    ...
    if (!snaf_drv_ver_ptr||(*snaf_drv_ver_ptr>SYM_SPI_NAND_VER)) {
